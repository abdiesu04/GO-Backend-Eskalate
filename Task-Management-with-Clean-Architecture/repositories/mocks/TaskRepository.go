...
func (_m *TaskRepository) CreateTask(ctx context.Context, task *domain.Task) error {
...
func (_m *TaskRepository) DeleteTask(ctx context.Context, id string) error {
...
func (_m *TaskRepository) UpdateTask(ctx context.Context, id string, updatedTask *domain.Task) error {
